    ...
    <div className="flex flex-col items-center gap-6">
      {connectionState === ConnectionState.DISCONNECTED ? (
        <div className="text-center">
            <button
                onClick={onConnect}
                className="group relative inline-flex items-center justify-center p-4 px-8 py-4 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-indigo-600 rounded-full shadow-md hover:bg-indigo-600 hover:text-white"
            >
        ...
        <div className="flex flex-col items-center animate-in fade-in zoom-in duration-300">
          <button
            ...
            className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${
              isConnecting 
                ...
                : 'bg-rose-500 hover:bg-rose-600 shadow-lg hover:shadow-xl hover:scale-105'
            }`}
          >
            {isConnecting ? (
          ...
          <span className="mt-3 text-xs font-medium tracking-wider text-slate-400 uppercase">
